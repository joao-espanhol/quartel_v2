# Generated by Django 5.1.1 on 2024-09-07 05:21
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('subunidade', models.CharField(choices=[('1ª Cia Fuz Mec', '1ª Companhia de Fuzileiros Mecanizada'), ('2ª Cia Fuz Mec', '2ª Companhia de Fuzileiros Mecanizada'), ('Cia C Ap', 'Companhia de Comando e Apoio'), ('SIBld', 'Seção de Instrução de Blindados'), ('NPOR', 'Núcleo de Preparação de Oficiais da Reserva'), ('CIOU', 'Centro de Instrução de Operações Urbanas'), ('EM', 'Estado Maior')], max_length=20)),
